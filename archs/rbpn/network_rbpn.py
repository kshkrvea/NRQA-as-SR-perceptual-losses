...
from archs.rbpn.base_networks import ConvBlock, ResnetBlock, DeconvBlock
from archs.rbpn.dbpns import DBPNS

class RBPN(nn.Module):
    def __init__(self, num_channels, base_filter, feat, num_stages, n_resblock, nFrames, upscale):
        ...
        ###DBPNS
        self.DBPN = DBPNS(base_filter, feat, num_stages, upscale)
